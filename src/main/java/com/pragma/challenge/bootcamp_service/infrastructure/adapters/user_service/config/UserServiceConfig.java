...
import com.pragma.challenge.bootcamp_service.infrastructure.adapters.user_service.util.UserServiceProperties;
...
public class UserServiceConfig {
  ...
  public WebClient userServiceWebClient() {
    return WebClient.builder()
        ...
        .clientConnector(
            getClientHttpConnector(Integer.parseInt(userServiceProperties.getTimeout())))
        .build();
  }
